...
export default function SubtopicDetailScreen() {
  ...
  const handleShare = async (item) => {
    try {
      await Share.share({
        message: item,
        title: `Shared from Florentia - ${decodedSubtopic}\ for more visit: https://vladimirgagarin.github.io/florentia/`,
      });
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View>
          <Text
            style={[styles.subtopicTitle, { color: darkTheme.colors.accent }]}
          >
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Ionicons
              ...
              onPress={() => router.push(`/topic/${slug}`)}
            />
            <Text
              style={[
                styles.emptyText,
            ...
            >
              No content yet go home and explore other subtopics!
            </Text>

            <TouchableOpacity
              onPress={() =>
                Linking.openURL(
                  `https://vladimirgagarin.github.io/florentia/?topic=${slug}&subtopic=${decodedSubtopic}`,
                )
              }
              style={[
                styles.card,
            ...
            >
              ...
              >
                We are sorry, but this subtopic is still growing. For more
          ...
          <View>
            ...
            >
              ...
              >
                ...
                FLORENTIA - "WHERE THOUGHTS BLOOM AND CONVERSATION FLOURISH"
              </Text>
              <Text style={{ color: "#fffb00", textDecorationLine: 'underline' }}>
                (click here)
              </Text>
            </TouchableOpacity>
          </View>
        ...
        ListEmptyComponentStyle={
          <View style={{ alignItems: 'center', justifyContent: 'center', padding: darkTheme.spacing.xlarge, marginTop: 50 }} >
            <Ionicons name="leaf-outline" size={60} color={darkTheme.colors.border} onPress={() => router.push(`/topic/${slug}`)} />
            <Text style={[styles.emptyText, { color: darkTheme.colors.secondaryText }]}>
              No content yet go home and explore other subtopics!
            </Text>
            <TouchableOpacity
              onPress={() => Linking.openURL(`https://vladimirgagarin.github.io/florentia/?topic=${slug}&subtopic=${decodedSubtopic}`)}
              style={[styles.card, { backgroundColor: darkTheme.colors.primary, marginTop: darkTheme.spacing.large }]}
            >
              <Text style={{ color: darkTheme.colors.text, fontWeight: 'bold', marginBottom: darkTheme.spacing.small }}>
                We are sorry, but this subtopic is still growing. For more content, visit our website.
              </Text>
            </TouchableOpacity>
            </View>
