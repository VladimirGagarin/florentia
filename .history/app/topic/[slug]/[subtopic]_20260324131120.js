        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptyText, { color: darkTheme.colors.secondaryText }]}>
              No content yet go home  or
              </Text>
             
              
            <TouchableOpacity
                onPress={() => Linking.openURL(`https://vladimirgagarin.github.io/personale/?topic=${slug}&subtopic=${decodedSubtopic}`)}
        ...
        ListFooterComponent={
          <View>
            <TouchableOpacity
                ...
                style={[styles.card, { backgroundColor: darkTheme.colors.primary, marginTop: darkTheme.spacing.large } ]}>
              <Text style={{ color: darkTheme.colors.text, fontWeight: 'bold', marginBottom: darkTheme.spacing.small }}>
                For more content, visit our website: https://vladimirgagarin.github.io/personale/
              </Text>
            </TouchableOpacity>
          </View>
        }
